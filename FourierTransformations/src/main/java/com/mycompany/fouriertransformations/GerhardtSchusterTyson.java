...
public class GerhardtSchusterTyson {
    ...
    final static int V_RECO = 20;	// In order to a cell jumps to the recovery state, V_RECO < v
    final static int V_EXCI = 75;	// To get a cell excited, v <= V_EXCI
    final static int G_UP = 10;
    final static int G_DOWN = 15;
