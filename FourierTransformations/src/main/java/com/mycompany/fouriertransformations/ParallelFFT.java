 ...
 * @author kamil
 */
public class ParallelFFT extends Thread {

    public static int N = 4096 ; //Img size
    ...
    public static void main(String [] args) throws Exception {
        ...
        ParallelFFT [] threads = new ParallelFFT [P] ;
          for(int me = 0 ; me < P ; me++) {
              threads [me] = new ParallelFFT(me) ;
              threads [me].start() ;
          }
